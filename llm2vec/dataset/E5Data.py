    ...
    def load_data(self, file_path: str = None):
        ...
        for dataset in E5_EMBEDDING_PROMPTS:
            ...
            for i, sample in enumerate(dataset_samples):
                ...
                query = f"{instruction} " + self.separator + sample["query"] + "</s>"
                pos = self.separator + sample["positive"] + " Use eight words to represent the above text in multiple aspects: <reserved_12><reserved_13><reserved_14><reserved_15><reserved_16><reserved_17><reserved_18><reserved_19>"
                neg = self.separator + sample["negative"] + " Use eight words to represent the above text in multiple aspects: <reserved_12><reserved_13><reserved_14><reserved_15><reserved_16><reserved_17><reserved_18><reserved_19>"
